      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-example4" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Valoracion Nutricional</a>
                  </li>
            </ul>
         </li>
         <li>
         ...
         <li>
            ...
            <ul id="dropdown-example1" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Detalles Peomociones</a>
                  </li>
                  <li>
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Detalles Pedidos</a>
                  </li>
                  <li>
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Area</a>
                  </li>
                  <li>
